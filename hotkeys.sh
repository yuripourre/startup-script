...
# Open Text Editor
$SETTINGS/custom3/ name "Open Text Editor"
$SETTINGS/custom3/ command "/usr/bin/gnome-text-editor"
$SETTINGS/custom3/ binding "<Primary><Alt>T"

# Open System Monitor (Ctrl + Alt + Del)
$SETTINGS/custom4/ name "Open System Monitor"
